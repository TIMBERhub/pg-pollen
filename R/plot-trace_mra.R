#' Trace plots from the output of `pg_stlm_mra()`
#'
#' @param out The output from `pg_stlm_mra()`
...
plot_trace_mra <- function(out, base_size = 12, num_plot = 10, file = NULL, width = 16, height = 9) {
    
    # TODO 
    # revise this for the MRA parameters
    ...
    if (class(out) != "pg_stlm_mra")
        stop("out must be of class pg_stlm_mra")
